...
export const CurrentlyPlaying: React.FC<CurrentlyPlayingProps> = () => {
    ...
    const currentTrack = useSelector((state:RootState)=>state.spotify.playbackState?.track_window.current_track)
    ...
    (<Flex direction='row' p='0.8rem' m='1rem'>
        <Image 
            ...
            width='4.5rem'
            height='4.5rem'/>
        <Flex align='center' m='0.3rem' p='1.5rem' width='full' direction='column'>
